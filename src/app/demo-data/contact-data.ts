...
export class ContactData implements InMemoryDbService {
    ...
    static lastNames = ["Beckham", "Cole", "Braxton", "Brennan", "El Arbi", "Bryson", "Cadwell",
    ...
    /* Used by in memory http web api */
    public createDb() : any {
        return {
    ...
    getContact(id:number) {
        return (this.contacts[id-1]).copy();
    }
